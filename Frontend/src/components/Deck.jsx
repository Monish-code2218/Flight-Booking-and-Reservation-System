              ...
              <div key={index}>
                ...
                <fieldset>
                  ...
                  <div className="flex items-center mb-4">
                    <input className="form-check-input w-4 m-3 h-4 border-gray-300    dark:bg-gray-700 dark:border-gray-600" type="radio" name={`gender-${index}`} id={`male-${index}`} value="Male" />
                    ...
                    <input className="form-check-input w-4 m-3  h-4 border-gray-300    dark:bg-gray-700 dark:border-gray-600" type="radio" name={`gender-${index}`} id={`female-${index}`} value="Female" />
    ...
    <div>
      <div className="bg-gray-100 p-10">
        <div className="row">
          <div className="column1">
            <div className="plane">
              <div className='flex justify-center items-center p-3'>
                <h1 className='font-bold '>Select Your Seats</h1>
              </div>
          ...
          <div className="column1">
            <div className='flex justify-center items-center p-3'>
              <h1 className='font-bold '>Airline Details</h1>
            </div>
            <Table>
              <TableHeader>
                <TableRow>
          ...
          <div className="column2">
            ...
            <div className="seatInfo">
              <div className='flex justify-center items-center p-3'>
                <h1 className='font-bold '>Add Passengers</h1>
              </div>
